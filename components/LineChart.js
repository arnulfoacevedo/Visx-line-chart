...
function LineChart({ data, width, height }) {
    ...
    // tooltip parameters
    const { tooltipData, tooltipLeft = 50, tooltipTop = 0, showTooltip, hideTooltip } = useTooltip();
    ...
    return (
        <div style={{ position: 'relative' }}>
            ...
            <rect x={0} y={0} width={width} height={height} fill={'#546373'} rx={14} />
                <Group left={margin.left} top={margin.top}>
                    ...
                    <text x="-5" y="20" transform="rotate(-90)" fontSize={12} fill='#EDF2F7'>
                        USD
                    </text>
                    <AxisBottom
                        scale={timeScale}
                    ...
                    {tooltipData && tooltipData.map((d, i) => (<g key={i}>
                        <GlyphCircle 
